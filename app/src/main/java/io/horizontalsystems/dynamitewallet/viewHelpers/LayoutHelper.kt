...
object LayoutHelper {
    ...
    fun getCoinDrawableResource(coinCode: String): Int {
        ...
        return io.horizontalsystems.dynamitewallet.core.App.instance.resources.getIdentifier(coinResourceName, "drawable", io.horizontalsystems.dynamitewallet.core.App.instance.packageName)
    }

    fun getLangDrawableResource(languageCode: String): Int {
        return io.horizontalsystems.dynamitewallet.core.App.instance.resources.getIdentifier("lang_$languageCode", "drawable", io.horizontalsystems.dynamitewallet.core.App.instance.packageName)
    }

    fun getCurrencyDrawableResource(currencyCode: String): Int {
        return io.horizontalsystems.dynamitewallet.core.App.instance.resources.getIdentifier("currency_$currencyCode", "drawable", io.horizontalsystems.dynamitewallet.core.App.instance.packageName)
    }
