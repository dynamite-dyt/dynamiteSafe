...
import io.horizontalsystems.dynamitewallet.core.IAppNumberFormatter
...
class NumberFormatter(private val languageManager: ILanguageManager): IAppNumberFormatter {
    ...
    override fun formatForTransactions(currencyValue: CurrencyValue, isIncoming: Boolean): SpannableString {
        ...
        //set color
        val amountTextColor = if (isIncoming) R.color.white else R.color.white
        val color = ContextCompat.getColor(io.horizontalsystems.dynamitewallet.core.App.instance, amountTextColor)
