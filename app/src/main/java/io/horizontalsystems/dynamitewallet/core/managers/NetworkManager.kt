...
import io.horizontalsystems.dynamitewallet.core.INetworkManager
import io.horizontalsystems.dynamitewallet.entities.LatestRateData
...
class NetworkManager(val appConfigProvider: IAppConfigProvider) : INetworkManager {
    ...
    override fun getLastestRateDataDYT(): Flowable<JsonObject> {
        return latestRateMainClientDYT
                .getLatestRate()
    ...
    private val latestRateMainClientDYT: ServiceExchangeApi.IExchangeRate = APIClient
            .retrofit("https://${appConfigProvider.dytMainGateway}/", timeout = 10)
            .create(ServiceExchangeApi.IExchangeRate::class.java)
...
object ServiceExchangeApi {
    ...
    interface IExchangeRate {
        ...
        @GET("data")
        fun getLatestRate(): Flowable<JsonObject>
