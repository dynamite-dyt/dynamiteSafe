...
class NetworkAvailabilityManager {
    ...
    private val connectivityManager = io.horizontalsystems.dynamitewallet.core.App.instance.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
