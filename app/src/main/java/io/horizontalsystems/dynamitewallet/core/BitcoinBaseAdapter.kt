...
import io.horizontalsystems.dynamitewallet.entities.PaymentRequestAddress
...
abstract class BitcoinBaseAdapter(override val coin: Coin, open val kit: AbstractKit, private val addressParser: AddressParser) : io.horizontalsystems.dynamitewallet.core.IAdapter {

    abstract val satoshisInBitcoin: BigDecimal
    abstract fun feeRate(feePriority: io.horizontalsystems.dynamitewallet.core.FeeRatePriority): Int
    ...
    override var state: io.horizontalsystems.dynamitewallet.core.AdapterState = io.horizontalsystems.dynamitewallet.core.AdapterState.Syncing(0, null)
        set(value) {
            field = value
    ...
    override fun send(address: String, value: BigDecimal, feePriority: io.horizontalsystems.dynamitewallet.core.FeeRatePriority): Single<Unit> {
