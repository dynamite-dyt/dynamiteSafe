...
class EthereumAdapter(coin: Coin,
                      ...
                      feeRateProvider: io.horizontalsystems.dynamitewallet.core.IFeeRateProvider) : io.horizontalsystems.dynamitewallet.core.EthereumBaseAdapter(coin, kit, 18, addressParser, feeRateProvider) {

    override val state: io.horizontalsystems.dynamitewallet.core.AdapterState
        get() = when (ethereumKit.syncState) {
            is EthereumKit.SyncState.Synced -> io.horizontalsystems.dynamitewallet.core.AdapterState.Synced
            is EthereumKit.SyncState.NotSynced -> io.horizontalsystems.dynamitewallet.core.AdapterState.NotSynced
            is EthereumKit.SyncState.Syncing -> io.horizontalsystems.dynamitewallet.core.AdapterState.Syncing(50, null)
        }
