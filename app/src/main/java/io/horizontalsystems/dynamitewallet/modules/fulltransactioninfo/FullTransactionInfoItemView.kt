...
import io.horizontalsystems.dynamitewallet.entities.FullTransactionIcon
...
class FullTransactionInfoItemView : ConstraintLayout {
    ...
    private fun showTypeIcon(icon: Int) {
        typeIcon.setImageDrawable(ContextCompat.getDrawable(io.horizontalsystems.dynamitewallet.core.App.instance, icon))
