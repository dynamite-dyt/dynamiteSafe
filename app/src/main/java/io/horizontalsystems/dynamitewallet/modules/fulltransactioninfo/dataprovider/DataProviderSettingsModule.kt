...
object DataProviderSettingsModule {
    ...
    fun init(coin: Coin, transactionHash: String, view: DataProviderSettingsViewModel) {
        val interactor = DataProviderSettingsInteractor(io.horizontalsystems.dynamitewallet.core.App.transactionDataProviderManager, io.horizontalsystems.dynamitewallet.core.App.networkManager)
