...
import io.horizontalsystems.dynamitewallet.ui.extensions.NumPadItem
import io.horizontalsystems.dynamitewallet.ui.extensions.NumPadItemType
import io.horizontalsystems.dynamitewallet.ui.extensions.NumPadItemsAdapter
        ...
        when (hintInfo) {
            is SendModule.HintInfo.Amount -> {
                val hintText = when (hintInfo.amountInfo) {
                    is SendModule.AmountInfo.CoinValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(hintInfo.amountInfo.coinValue, realNumber = true)
                    is SendModule.AmountInfo.CurrencyValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(hintInfo.amountInfo.currencyValue)
                }
                ...
                val errorText: String? = when (hintInfo.error) {
                    is SendModule.AmountError.InsufficientBalance -> {
                        val balanceAmount = when (hintInfo.error.amountInfo) {
                            is SendModule.AmountInfo.CoinValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(hintInfo.error.amountInfo.coinValue)
                            is SendModule.AmountInfo.CurrencyValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(hintInfo.error.amountInfo.currencyValue)
                        }
        ...
        feeInfo?.let {
            ...
            it.error?.let { erc20Error ->
                ...
                val primaryFee = when (primaryFeeInfo) {
                    is SendModule.AmountInfo.CurrencyValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(primaryFeeInfo.currencyValue)
                    is SendModule.AmountInfo.CoinValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(primaryFeeInfo.coinValue)
                    else -> ""
                }
                ...
                txtFeeSecondary.text = when (secondaryFeeInfo) {
                    is SendModule.AmountInfo.CurrencyValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(secondaryFeeInfo.currencyValue)
                    is SendModule.AmountInfo.CoinValueInfo -> io.horizontalsystems.dynamitewallet.core.App.numberFormatter.format(secondaryFeeInfo.coinValue)
                    else -> ""
                }
            }
        }
