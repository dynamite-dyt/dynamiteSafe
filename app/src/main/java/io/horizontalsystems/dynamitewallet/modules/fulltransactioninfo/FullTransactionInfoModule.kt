...
import io.horizontalsystems.dynamitewallet.entities.FullTransactionItem
import io.horizontalsystems.dynamitewallet.entities.FullTransactionRecord
import io.horizontalsystems.dynamitewallet.entities.FullTransactionSection
...
object FullTransactionInfoModule {
    ...
    fun init(view: FullTransactionInfoViewModel, router: Router, coin: Coin, transactionHash: String) {
        val interactor = FullTransactionInfoInteractor(io.horizontalsystems.dynamitewallet.core.App.transactionInfoFactory, io.horizontalsystems.dynamitewallet.core.App.transactionDataProviderManager, TextHelper)
