...
class ManageCoinsActivity : io.horizontalsystems.dynamitewallet.BaseActivity(), ManageCoinsAdapter.Listener, StartDragListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shadowlessToolbar.bind(
                ...
                rightBtnItem = TopMenuItem(R.drawable.surface1, { viewModel.delegate.saveChanges() })
        )
