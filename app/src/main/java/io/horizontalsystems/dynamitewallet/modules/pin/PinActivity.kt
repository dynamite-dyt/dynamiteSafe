...
import io.horizontalsystems.dynamitewallet.core.security.FingerprintAuthenticationDialogFragment
import io.horizontalsystems.dynamitewallet.modules.main.MainModule
import io.horizontalsystems.dynamitewallet.ui.extensions.*
...
import kotlinx.android.synthetic.main.activity_pin.pinUnlock
import kotlinx.android.synthetic.main.view_pin_page.*


class PinActivity : io.horizontalsystems.dynamitewallet.BaseActivity(), NumPadItemsAdapter.Listener, FingerprintAuthenticationDialogFragment.Callback {
    ...
    private fun showFingerprintDialog(cryptoObject: FingerprintManagerCompat.CryptoObject) {
        if (io.horizontalsystems.dynamitewallet.core.App.systemInfoManager.touchSensorCanBeUsed()) {
    ...
    companion object {
        ...
        fun startForUnlock(context: Context, showCancel: Boolean) {
            val intent = Intent(io.horizontalsystems.dynamitewallet.core.App.instance, PinActivity::class.java)
...
class PinPageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    private fun updatePinCircles(length: Int) {
        val filledCircle = R.drawable.circle_filled
        val emptyCircle = R.drawable.circle_empty
