...
import io.horizontalsystems.dynamitewallet.ui.view.ViewHolderProgressbar
...
class DataProviderSettingsActivity : io.horizontalsystems.dynamitewallet.BaseActivity(), DataProviderSettingsAdapter.Listener {
