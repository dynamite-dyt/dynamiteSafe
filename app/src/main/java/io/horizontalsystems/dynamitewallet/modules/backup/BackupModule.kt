...
object BackupModule {
    ...
    fun init(view: BackupViewModel, router: IRouter, keystoreSafeExecute: IKeyStoreSafeExecute, dismissMode: BackupPresenter.DismissMode) {
        val interactor = BackupInteractor(io.horizontalsystems.dynamitewallet.core.App.authManager, io.horizontalsystems.dynamitewallet.core.App.wordsManager, io.horizontalsystems.dynamitewallet.core.App.randomManager, io.horizontalsystems.dynamitewallet.core.App.localStorage, keystoreSafeExecute)
